...
export default function Avatars() {
  return (
    <>
      <PageMeta
        title="SMS Avatars Dashboard | Kizuna - SMS Admin Dashboard Template"
        description="This is SMS Avatars Dashboard page for Kizuna - SMS Tailwind CSS Admin Dashboard Template"
      />
