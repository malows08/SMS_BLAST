...
export default function Badges() {
  return (
    <div>
      <PageMeta
        title="SMS Badges Dashboard | Kizuna - SMS Admin Dashboard Template"
        description="This is SMS Badges Dashboard page for Kizuna - SMS Tailwind CSS Admin Dashboard Template"
      />
